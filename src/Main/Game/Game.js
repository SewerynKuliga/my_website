    ...
    <Container>
      ...
      <FirstGame>
        <P>
          ...
          Jest to gra logiczna, która posiada kilka poziomów.
          <br />
          Pierwszy poziom jest najłatwiejszy, ale już w następnym i kolejnych
        ...
        <LetsPlay
          // onClick={handleClick}
          onClick={() => {
            alert("Gra w procesie tworzenia. Proszę wrócić później ;)");
          }}
        >
          ZAGRAJ!
        </LetsPlay>
