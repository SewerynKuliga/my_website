    ...
    <Container>
      ...
      >
        ...
        <CourseDescription>
          ...
          <li>
            - nauka funkcji, instrukcji warunkowych oraz operatorów
            arytmetycznych{" "}
          </li>
        </CourseDescription>
        ...
        <Links>
          Link:&nbsp;
          <Link
            href="https://www.udemy.com/course/javascript-od-podstaw-do-eksperta"
            target="_blank"
          >
      ...
      >
        ...
        <CourseDescription>
          ...
          <li>
            - wykorzystywanie obecnie panujących standardów przygotowywania
            projektów
          </li>
        ...
        <Links>
          Link:&nbsp;
          <Link
            href="https://www.udemy.com/course/kurs-html-i-css-od-podstaw"
            target="_blank"
          >
