    ...
    <Container>
      ...
      <OakfusionCompany>
        ...
        <ListOfDuties>
          ...
          <li>
            - rozwijanie kompetencji miękkich podczas pracy w małej grupie
          </li>
        ...
        <MyOpinion>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pierwsze miejsce pracy, w którym miałem
          do czynienia z zespołem stażystów, gdzie każdy dbał o wzajemne
          relacje. Poprzez wspieranie się wzajemnie w zadaniach, a także poza
          nimi, atmosfera przybrała postać prawdziwie zgranego zespołu.
          Wyniosłem z tego stażu ogrom wiedzy (głownie z TypeScript), która
          poprawiła moje umiejętności pisania zrozumiałego i prostego do analizy
          kodu. Przez Code Review z mentorem uczyłem się czego unikać w procesie
          tworzenia aplikacji, co poprawić żeby było bardziej czytelne, ale też
          jakie dobre nawyki kodowania mam już wyrobione.
        </MyOpinion>
      </OakfusionCompany>
    </Container>
  );
